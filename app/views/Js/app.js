...
let btnAdd=document.getElementById('btnAdd');
    btnAdd.addEventListener('click',()=>{
        ...
        console.log(datos);
        fetch('http://localhost:8081/ventas/producto',{
            method:'POST',
    ...
    btnCarrito.addEventListener('click',()=>{
        ...
        fetch(`http://localhost:8081/ventas/producto/${menu}`)
        .then(res=>res.json())
        .then(json=>{
...
//Si está leyendo esto profe, el trabajo pertenece a Sebastián de 3D
    ...
    btnFactura=document.getElementById('btnFactura');
        btnFactura.addEventListener('click',()=>{
            ...
            fetch('http://localhost:8081/ventas/factura',{
                method:'POST',
